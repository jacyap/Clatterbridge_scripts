...
# Create directory combined files will be saved to
mkdir combined
...
for file in $(ls -v sims/1/data)
do
    # Get the position the output file corresponds to
    tracking_pos=$(echo ${file} | tr -dc '0-9')
